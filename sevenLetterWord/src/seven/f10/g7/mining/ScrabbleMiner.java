...
import seven.f10.g7.mining.DataMine;
import seven.f10.g7.mining.DataMine.ItemSet;
import seven.f10.g7.mining.LetterMine;
import seven.f10.g7.mining.LetterMine.LetterSet;
...
public class ScrabbleMiner {
	...
	public static void main(String[] args) {
		...
		item[0]=new String("Z");
		System.out.println(mine.getCachedItemSet(item).getSupport());
